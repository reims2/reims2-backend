...
public class CustomGlassesRepositoryImpl implements CustomGlassesRepository {
    ...
    @Override
    @Transactional
    public void saveGlassesWithNextPossibleSKU(Glasses glasses, Eye OS, Eye OD) {
        ...
        entityManager.createNativeQuery("INSERT INTO glasses ( glasses_type, glasses_size, appearance,location, SKU ,OS_ID, OD_ID) VALUES (?,?,?,?,?,?,?)")
